...
<div id="prenotazioni">
    <form id="filerPrenotazioniForm" class="filerForm" action="CercaPrenotazione" method="post">
    ...
    <div class="customer_card active_customer" onclick="servletToGet('./MostraPrenotazioni?username=${sessionScope.loggedUser.username}')">
        <div>
